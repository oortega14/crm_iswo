...
Rails.application.configure do
  ...
  # En desarrollo usa memoria (más rápido). Solid Cache se prueba con SOLID_CACHE=1.
  if ENV["SOLID_CACHE"]
  ...
  # Solid Queue — jobs en PostgreSQL (misma instancia que el CRM en dev).
  ...
  # Cualquier subdominio ngrok (la URL cambia al reiniciar ngrok).
